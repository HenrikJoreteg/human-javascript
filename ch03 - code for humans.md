...
For a more in-depth discussion on style and style guides I highly recommend reading Airbnb's javscript style guide: https://github.com/airbnb/javascript. It will give you a good overview of the various common style discrepencies and some of the reasoning behind some of the choices. It's also a great starting point if you want to fork it and tweak it to be "the style guide" for your team.
